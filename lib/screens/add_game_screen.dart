...
// Screen for adding a new game session
class AddGameScreen extends StatefulWidget {
  ...
  final UserSettings userSettings; // Default values from settings
...
class _AddGameScreenState extends State<AddGameScreen> {
  ...
  void initState() {
    super.initState();
    // Initialize with user settings defaults
    _gameTitleController = TextEditingController();
    _courtNameController = TextEditingController(text: widget.userSettings.defaultCourtName);
    _courtRateController = TextEditingController(
      text: widget.userSettings.defaultCourtRate > 0
          ? widget.userSettings.defaultCourtRate.toStringAsFixed(2)
          : '',
    );
    _shuttleCockPriceController = TextEditingController(
      text: widget.userSettings.defaultShuttleCockPrice > 0
          ? widget.userSettings.defaultShuttleCockPrice.toStringAsFixed(2)
          : '',
    );
